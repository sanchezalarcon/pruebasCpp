...
float ListaNodoCuatroReales::ObtenerW(){
      return w;
}

float ListaNodoCuatroReales::ObtenerX(){
      return x;
}

float ListaNodoCuatroReales::ObtenerY(){
      return y;
}

float ListaNodoCuatroReales::ObtenerZ(){
      return z;
}

void ListaNodoCuatroReales::AsignarW(float w){
      this->w=w;
}

void ListaNodoCuatroReales::AsignarX(float x){
      this->x=x;
}

void ListaNodoCuatroReales::AsignarY(float y){
      this->y=y;
}
		   
void ListaNodoCuatroReales::AsignarZ(float z){
      this->z=z;
}
