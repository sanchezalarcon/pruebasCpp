...
#ifndef __INTERVALOPREDICCION_H
#define __INTERVALOPREDICCION_H
#include "Lista.h"

class IntervaloPrediccion{
    private:
           float SumatoriaW(Lista * lista);
           float SumatoriaX(Lista * lista);
           float SumatoriaY(Lista * lista);
           float SumatoriaWWA2(Lista * lista,float wa);
           float SumatoriaXXA2(Lista * lista,float xa);
           float SumatoriaYYA2(Lista * lista,float ya);
           float CalcularDesviacion(Lista * lista, float b0, float b1);
           float CalcularDesviacionMultiple(Lista * lista, float b0, float b1,float b2, float b3);
   public:
           IntervaloPrediccion();
           ~IntervaloPrediccion();
           void Calcular(Lista * lista, float xk, float yk, float  b0,float b1, float & range, float & upi, float & lpi);
           void CalcularMultiple(Lista * lista, float wk, float xk, float yk, float zk, float  b0,float b1, float b2, float b3, float & range, float & upi, float & lpi);
};
