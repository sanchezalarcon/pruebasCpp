...
#ifndef __REGRESIONLINEAL_H
#define __REGRESIONLINEAL_H
#include "Lista.h"
...
class RegresionLineal{
    private:
           ...
           float SumatoriaZ(Lista * lista);
           float SumatoriaWX(Lista * lista);
           float SumatoriaXY(Lista * lista);
           float SumatoriaWY(Lista * lista);
           float SumatoriaWZ(Lista * lista);
           float SumatoriaXZ(Lista * lista);
           float SumatoriaYZ(Lista * lista);
           float SumatoriaW2(Lista * lista);
           float SumatoriaX2(Lista * lista);
           float SumatoriaY2(Lista * lista);
   public:
           RegresionLineal();
           ~RegresionLineal();
           void Calcular(Lista * lista, float xk, float & b0, float & b1, float & rxy, float &r2, float & yk);
           void CalcularMultiple(Lista * lista, float wk, float xk, float yk, float & b0, float & b1, float & b2, float & b3,float & rxy, float &r2, float & zk);
};
